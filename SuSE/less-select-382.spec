#
# spec file for package less-select (Version 382)
#
...
# BuildRequires: aaa_base acl attr bash bind-utils bison bzip2 coreutils cpio cpp cracklib cvs cyrus-sasl db devs diffutils e2fsprogs file filesystem fillup findutils flex gawk gdbm-devel glibc glibc-devel glibc-locale gpm grep groff gzip info insserv libacl libattr libgcc libnscd libselinux libstdc++ libxcrypt libzio m4 make man mktemp module-init-tools ncurses ncurses-devel net-tools netcfg openldap2-client openssl pam pam-modules patch permissions popt procinfo procps psmisc pwdutils rcs readline sed strace syslogd sysvinit tar tcpd texinfo timezone unzip util-linux vim zlib zlib-devel autoconf automake binutils gcc gdbm gettext libtool perl rpm

%define rel 40
%define suserel SuSE9.2
...
Patch6:       less-%{version}-localefix.patch
Patch7:       less-%{version}-strict_aliasing.patch
Patch8:       less-%{version}-mouse.patch
Patch9:       less-%{version}-search_string_utf8.patch
Patch10:      less-%{version}-terminate.patch
Patch11:      less-%{version}-search_ansi_esc_seq.patch
NoPatch:      0
NoPatch:      1
NoPatch:      2
NoPatch:      3
...
patch -p1 <less-%{version}-%{suserel}-select.patch
...
%changelog
* Thu Nov 11 2004 - martin@mvath.de
